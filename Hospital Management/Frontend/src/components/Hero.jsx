...
// it accept 2 props - title and the imageUrl
    ...
    <>
      <div className="hero container">
        <div className="banner">
          <h1>{title}</h1>
          <p>
            AgarwalCare Medical Institute is a state-of-the-art facility
            ...
            needs. At AgarwalCare, we prioritize your well-being, ensuring a
